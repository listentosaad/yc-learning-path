...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-[#f0ede8] overflow-x-hidden font-sans">
      ...
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 h-[52px] flex items-center justify-end px-6 z-[90] pointer-events-none">
        <img
          src="/assets/logo.svg"
          className="h-7 w-auto opacity-85 pointer-events-auto transition-opacity duration-200 hover:opacity-100"
          alt="دليل المؤسس"
        />
      </nav>
      ...
      <div className="max-w-[780px] mx-auto px-4 sm:px-6 pb-20">
        ...
        {/* Hero */}
        <div className="pt-[72px] sm:pt-[120px] pb-12 sm:pb-16 text-center">
          <div className="inline-flex items-center gap-2 text-[11px] font-medium tracking-[0.12em] text-[var(--accent)] uppercase mb-7 px-[14px] py-[6px] border border-[var(--accent-dim)] rounded-full bg-[var(--accent-glow)]">
          ...
          <div className="flex justify-center gap-5 sm:gap-8 mb-4">
            ...
            <div className="flex flex-col items-center gap-0.5">
              <span className="text-[20px] font-bold tabular-nums">{TOTAL - totalDone}</span>
      ...
      <footer className="text-center px-6 pt-12 pb-8 border-t border-white/[0.06] mt-16">
        ...
        <div className="flex items-center justify-center gap-[14px] mt-2.5">
          <a className="text-[#3d3b38] transition-colors duration-200 flex items-center hover:text-[#7a7672]" href="#" aria-label="تويتر">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
          </a>
          <a className="text-[#3d3b38] transition-colors duration-200 flex items-center hover:text-[#7a7672]" href="#" aria-label="انستقرام">
          ...
          <a className="text-[#3d3b38] transition-colors duration-200 flex items-center hover:text-[#7a7672]" href="#" aria-label="لينكدإن">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a className="text-[#3d3b38] transition-colors duration-200 flex items-center hover:text-[#7a7672]" href="#" aria-label="غيتهب">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
